...
import com.olgunyilmaz.eventbox.helper.ProfileHelper;
import com.olgunyilmaz.eventbox.util.UserManager;
import com.olgunyilmaz.eventbox.util.ImageLoader;
...
public class ProfileFragment extends Fragment {
    ...
    private void editMode() {
        ...
        binding.deleteMyAccountButton.setVisibility(View.INVISIBLE);
